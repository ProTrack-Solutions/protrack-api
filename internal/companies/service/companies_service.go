...
func (s *Service) CreateCompany(
	...
	company, err := companyRepo.CreateCompany(ctx, db.CreateCompanyParams{
		...
		InscricaoEstadual:       pgconv.ParseStringToPgText(req.InscricaoEstadual),
		InscricaoEstadualIsento: req.InscricaoEstadualIsento,
		Cnae:                    pgconv.ParseStringToPgText(req.Cnae),
	...
	return domain.CompanyResponse{
		...
		InscricaoEstadual:       pgconv.ParsePgTextToString(company.InscricaoEstadual),
		InscricaoEstadualIsento: company.InscricaoEstadualIsento,
		Cnae:                    pgconv.ParsePgTextToString(company.Cnae),
...
func (s *Service) UpdateCompany(ctx context.Context, id uuid.UUID, req domain.UpdateCompanyRequest) (domain.CompanyResponse, error) {
	...
	arg := db.UpdateCompanyParams{
		...
		InscricaoEstadualIsento: currentCompany.InscricaoEstadualIsento,
