...
func RequireModule(moduleCode string, queries *db.Queries) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		hasAccess, err := queries.DepartmentHasModule(c.Request.Context(), db.DepartmentHasModuleParams{
