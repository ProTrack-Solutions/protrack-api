...
CREATE INDEX IF NOT EXISTS idx_invoice_history_company_id ON invoice_history(company_id);
CREATE INDEX IF NOT EXISTS idx_invoice_history_subscription ON invoice_history(subscription_id);
